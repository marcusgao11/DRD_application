  subroutine PhSolve_ori(rmu_after,ph_after,t)
  use global
  implicit none
...
!  external MATRIX_VECTOR,PSolve
  ...
  external MATRIX_VECTOR_CG_ori,PSolve_CG_ori
  integer ITER,INFO
...
ITER = 500
RESID = tol
    call BICGSTAB(nr*nz,rhs,Computed_Solution,work,nr*nz,ITER,RESID,MATRIX_VECTOR_CG_ori,PSolve_CG_ori,INFO)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!! Matrix operator of linear system for CH equation
  subroutine  MATRIX_VECTOR_CG_ori(alpha,xx,beta,yy)
  use global
  implicit none
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!        FFT based preconditioner for GMRES
  subroutine PSolve_CG_ori(yy,xx)
  use global
  implicit none
  real xx(nr*nz),yy(nr*nz)
  real f1(-1:nr,-1:nz),f2(-1:nr,-1:nz)
