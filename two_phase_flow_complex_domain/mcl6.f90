    ...
    logical,parameter::is_fluid = .true. !.true.
...
! backup file
call systemqq('cp input  datainput')
call systemqq('cp global.f90  dataglobal.f90')
call systemqq('cp finit.f90  datafinit.f90')
...
!!!!!! initialize some parameters
    ...
    phi_mode = 2 ! 2  ! 1: phi from 0 to 1, 2: phi from -1 to 1
    ...
    u = 0.0; ph = 0.0; rmu = 0.0; p = 0.0; rho = 0.0; eta = 0.0;
    v = 0.0; 
...
write(6,*) 're= finit', re
  ...
  !   do k=1,nz-1
  !     do i=0,nr-1
  !        v(i,k) = (ph(i,k) + ph(i,k-1))/2.0 * (-10.0);
  !     enddo
  !  enddo
