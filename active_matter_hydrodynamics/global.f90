...
!    integer,parameter::nz=150
    ...
    integer,parameter::nr=200 !400
    integer,parameter::nz=200 !400
...
!    real,parameter::pi=2*acos(0.0)
    ...
    real,parameter::vel_solver_type = 2  
    ! 1 for pressure Poisson, 2 for pressure correction
    ! ns_solver
...
!ph Laplace coefficient,Velocity Laplace coefficient,pressure Laplace for cosine
    ...
    real Ve_Lcc(0:nr,0:nz),Pre_Lcc(0:nr,0:nz), Pre_Lpp(0:nr,0:nz)
    ...
    real bdr_ph(-1:nr,-1:nz), ph_swm(-1:nr,-1:nz)
...
!    public Ph_Lcf,Ph_Lcf_2
    ...
    public fmy,wsaveyc,fmx,wsavexc,wsavexc_v,Ph_Lcc,Ve_Lcc,Pre_Lcc
    public Ph_Lcc_2,Ve_Lcc_2 !,Pre_Lf,wsavexf,wsaveyf
    public Ph_Lcf,Ph_Lcf_2, plan, plan_back
    public wsavexf,wsaveyf, Pre_Lpp
