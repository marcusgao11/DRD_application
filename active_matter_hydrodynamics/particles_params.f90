...
!    real,parameter::fpd_radius   = 0.05
    ...
    ! test cases
    ! swimmer
    integer,parameter::Np_swm = 40 !15 !25

    real,parameter::swm_radius   = 0.05/2.0

    real,parameter::swm_bp_dist  = 0.075 !0.05 ! position determined by angle and dist
    ...
    real, parameter :: kb = 0.0025 !*1000 !0.05
    real, parameter :: Theta0 = 0.0

    integer,parameter::Np = 15 ! 9
    ...
    ! parameters for tumbles
    logical,parameter:: is_Tumbles_on = .true.
    real,parameter::fpd_Alpha = 1/0.1  ! 1/0.05 !1/0.5 !1/0.05  ! 0.1  0.5: 0524
